...
def build_prompt() -> str:
    p = (
        ...
        "4. Si se proporciona número de guía, menciona cuál es al final. No esta relacionado con el motivo del mensaje. Solo pondras al final que es la nueva guia y la paqueteria que a quien pertenece.\n"
